...
class RecoveryKeyService {
  ...
  Future<bool> recoverWithPassphrase(String passphrase) async {
    if (_currentUser == null) throw StateError('User not logged in');
    ...
    try {
      ...
      await _registerDeviceWithRecoveredUMK(umk);
  ...
  Future<void> _registerDeviceWithRecoveredUMK(Uint8List umk) async {
